...
const AmmoExtension = ({ ammo, handleSetAmmo }) => {
	...
	return (
		<section className="p-4 mt-6">
			<h3 className="text-[#e0cda9] font-semibold text-lg mb-4 border-b border-[#6f553e] pb-1">Detalles de Munición</h3>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div>
					<label htmlFor="material" className="block mb-1 font-semibold tracking-wide text-[#dbc59a]">
						Material
					</label>
					<SelectGAC id="material" value={material} onChange={(e) => setMaterial(e.target.value)}>
