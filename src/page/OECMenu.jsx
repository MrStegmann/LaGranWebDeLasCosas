    ...
    <PageGAC>
      ...
      <div className="mb-16 text-center relative">
        <h1 className="relative text-6xl md:text-7xl font-extrabold text-[#dca34c] tracking-widest select-none drop-shadow-[0_0_8px_rgba(143,87,5,0.6)]">
          Gestor de Oneshots, eventos y campañas
          <svg
        ...
        <h3 className="mt-5 relative text-4xl md:text-lg font-extrabold text-[#dca34c] tracking-widest select-none drop-shadow-[0_0_8px_rgba(143,87,5,0.6)]">
          Para crear hechizos y habilidades
        </h3>
      </div>
      ...
      <nav
        role="navigation"
        aria-label="Gestor de Oneshots, Eventos y Campañas"
