	...
	return (
		<PageGAC>
			...
			<div className="mb-16 text-center relative">
				...
				<h3 className="mt-5 relative text-4xl md:text-lg font-extrabold text-[#dca34c] tracking-widest select-none drop-shadow-[0_0_8px_rgba(143,87,5,0.6)]">Para crear NPCs y Personajes</h3>
			</div>

			{/* Navegación principal */}
			<nav role="navigation" aria-label="Creador de Fichas" className="flex flex-col gap-6 w-full max-w-sm text-center">
				{[
					{
						to: '/sheets/characters',
						label: 'Personajes',
					},
					{
						to: '/sheets/npcs',
