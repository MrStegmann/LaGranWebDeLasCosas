...
const Grimoire = () => {
	const { handleCreateSpell, handleUpdateSpell, handleDeleteSpell, handleCreateSkill, handleUpdateSkill, handleDeleteSkill } = useSaS();
	...
	return (
		<PageGAC>
			<ConfirmModal isOpen={openModal} message={'¿Estás seguro de que quieres eliminar este Personaje? Esta acción es irreversible.'} onConfirm={deleteSaS} onCancel={() => setOpenModal(false)} />
			...
			{sasOption === 'spell' ? (
				<div className="flex flex-row justify-justify p-5 w-full">
					{createSaS ? (
						...
						<>
							{editSaS ? (
								selectedSaS && <SpellForm spellData={selectedSaS} handleSubmit={updateSaS} />
							) : (
								<>
									<SpellList handleShow={handleShow} handleEdit={handleEdit} handleDelete={handleDelete} />
				...
				<div className="flex flex-row justify-justify p-5 w-full">
					{createSaS ? (
						...
						<>
							{editSaS ? (
								selectedSaS && <SkillForm skillData={selectedSaS} handleSubmit={updateSaS} />
							) : (
								<>
									<SkillList handleShow={handleShow} handleEdit={handleEdit} handleDelete={handleDelete} />
